...
Each category is given a score out of 5, and then given a letter grade based on how well they meet the above criteria.
...
Regardless of the results, let's appreciate these unsuspecting cities for publishing their bikeshare data! Some of these cities may have earned low ratings, but they're all better than the cities who have made their data available for public consumption. Without further ado, let's ride!

### A+ Cities

> Leading the pack on a smooth, fast ride, these cities offer exceptional data quality - complete, consistent, and effortlessly accessible like cruising down a perfectly paved Amsterdam bike lane.
